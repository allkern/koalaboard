...
// Bus adapter
uint32_t bus_ic_read32(uint32_t, void*);
uint32_t bus_ic_read16(uint32_t, void*);
uint32_t bus_ic_read8(uint32_t, void*);
void bus_ic_write32(uint32_t, uint32_t, void*);
void bus_ic_write16(uint32_t, uint16_t, void*);
void bus_ic_write8(uint32_t, uint8_t, void*);
